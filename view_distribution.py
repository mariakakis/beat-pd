...
for label_name in ['on_off', 'dyskinesia', 'tremor']:
    ...
    p0 = plt.bar(ind, cnts[0], width=0.35)
    p1 = plt.bar(ind, cnts[1], width=0.35, bottom=cnts[0])
    p2 = plt.bar(ind, cnts[2], width=0.35, bottom=cnts[0]+cnts[1])
    p3 = plt.bar(ind, cnts[3], width=0.35, bottom=cnts[0]+cnts[1]+cnts[2])
    p4 = plt.bar(ind, cnts[4], width=0.35, bottom=cnts[0]+cnts[1]+cnts[2]+cnts[3])
    ...
    p0 = plt.bar(ind, norm_cnts[0], width=0.35)
    p1 = plt.bar(ind, norm_cnts[1], width=0.35, bottom=norm_cnts[0])
    p2 = plt.bar(ind, norm_cnts[2], width=0.35, bottom=norm_cnts[0]+norm_cnts[1])
    p3 = plt.bar(ind, norm_cnts[3], width=0.35, bottom=norm_cnts[0]+norm_cnts[1]+norm_cnts[2])
    p4 = plt.bar(ind, norm_cnts[4], width=0.35, bottom=norm_cnts[0]+norm_cnts[1]+norm_cnts[2]+norm_cnts[3])
    plt.xticks(ind, sorted_subjects), plt.setp(ax.xaxis.get_majorticklabels(), rotation=90)
